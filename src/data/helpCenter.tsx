/* ═══════════════════════════════════════════════════════════════
   OmniChat Help Center — CMS-ready Documentation Data Layer
...
export const HELP_ARTICLES: DocArticle[] = [
  /* ══ GETTING STARTED ══ */
  {
    ...
    title: "Create Your OmniChat Account",
    ...
    popular: true,
    steps: [
      { title: "Visit the Sign-Up Page", body: "Navigate to omnichat.io and click Get Started Free in the top navigation. You can also sign up with Google or Microsoft SSO.", imagePlaceholder: "Screenshot: OmniChat homepage with signup CTA highlighted" },
      ...
      { title: "Verify Your Email", body: "Check your inbox for a verification email from noreply@omnichat.io. Click Verify Email. Check spam if it does not arrive within 2 minutes.", tip: "Whitelist @omnichat.io in your email client to ensure deliverability." },
      { title: "Create Your Workspace", body: "Choose a workspace name (typically your company name), select your industry, and enter your team size. This helps OmniChat pre-configure recommended settings.", imagePlaceholder: "Screenshot: Workspace creation form" },
  ...
  /* ══ CHANNELS ══ */
  {
    ...
    excerpt: "Link your WhatsApp Business number to OmniChat via the official Meta Business API — step by step.",
    category: "channels",
    section: "whatsapp",
    ...
    popular: true,
    steps: [
      { title: "Prerequisites", body: "You need: a verified Meta Business Manager account, a dedicated phone number (not previously used on WhatsApp personal or Business App), and an active OmniChat Pro or above plan.", warning: "Numbers previously used on WhatsApp personal cannot be registered on the API without first deleting the existing account." },
      { title: "Open Channel Settings", body: "In OmniChat go to Settings → Channels → Add Channel → WhatsApp Business API. Click Connect with Meta.", imagePlaceholder: "Screenshot: Add Channel → WhatsApp selection screen" },
      ...
      { title: "Configure Webhook", body: "OmniChat automatically sets the webhook URL and token in your WABA settings. Verify that all webhook fields (messages, message_deliveries, message_reads) are subscribed.", code: "Webhook URL (auto-filled):\nhttps://api.omnichat.io/webhooks/whatsapp/{workspace-id}\n\nVerify Token (auto-filled):\nomni_wh_{unique-token}" },
      { title: "Send a Test Message", body: "Use the Test Message panel in OmniChat to send a template message to your own number. If received, the channel is live.", tip: "You must use a pre-approved message template for the first outbound message to a number that has not messaged you in the last 24 hours." },
    ],
  ...
  },
  {
    ...
    excerpt: "Reach thousands of opted-in contacts simultaneously using approved templates via the OmniChat broadcast tool.",
    category: "channels",
    section: "whatsapp",
  ...
  },
  {
    ...
    excerpt: "Link your Instagram Business or Creator account to receive and reply to DMs and story mentions inside OmniChat.",
    category: "channels",
    ...
    steps: [
      ...
      { title: "Configure Message Types", body: "Choose which message types to receive: DMs, Story Mentions, Story Replies, Post Comments. Each can be toggled independently.", tip: "Enabling Story Mentions lets you see when customers tag your brand in their stories and respond directly in OmniChat." },
      { title: "Test the Connection", body: "Send a DM to your Instagram account from another account. It should appear in your OmniChat inbox within seconds.", imagePlaceholder: "Screenshot: Instagram message appearing in OmniChat inbox" },
    ],
  ...
  },
  {
    ...
    excerpt: "Bring your support or sales email into OmniChat — connect Gmail, Outlook, or any custom IMAP/SMTP mailbox.",
    category: "channels",
    section: "email",
    ...
    steps: [
      ...
      { title: "Connect Gmail", body: "For Gmail: click Connect Google Account. Authorise OmniChat with your Google Workspace account. Select the Gmail mailbox to sync. OmniChat uses Gmail API (not IMAP) for reliable deliverability.", warning: "Ensure you are authorising with the email address you want to use as the support inbox, not your personal Gmail." },
      { title: "Connect Outlook / Microsoft 365", body: "For Outlook: click Connect Microsoft Account. Authorise via Microsoft OAuth. Choose the target mailbox. OmniChat syncs via Microsoft Graph API.", imagePlaceholder: "Screenshot: Microsoft OAuth consent screen" },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Import Contacts via CSV", body: "Go to Contacts → Import. Download the CSV template. Fill in: name, email, phone, company, and custom attributes. Upload. OmniChat deduplicates by email and phone.", code: "Required CSV columns:\nname, email, phone\nOptional columns:\ncompany, location, tags, custom_attr_1, custom_attr_2" },
      ...
      { title: "Sync CRM Data", body: "If using HubSpot, Salesforce, or Pipedrive integration, contact data syncs bidirectionally. Changes in OmniChat reflect in your CRM and vice versa — no duplicate data entry.", imagePlaceholder: "Screenshot: CRM sync settings panel showing field mappings" },
    ],
  ...
  /* ══ AI & AUTOMATION ══ */
  {
    ...
    excerpt: "Configure OmniChat&#39;s AI Agent to autonomously handle FAQs, qualify leads, and escalate to humans — without any coding.",
    ...
    steps: [
      ...
      { title: "Connect Your Knowledge Base", body: "The AI Agent learns from your content. Upload: PDFs, DOCX files, or paste plain text. Or connect a public URL (help docs, FAQ page, product pages) — OmniChat crawls and indexes automatically.", tip: "The more structured and factual your knowledge base content, the more accurate AI responses will be. Avoid promotional language in source materials." },
  ...
  /* ══ INTEGRATIONS ══ */
  {
    ...
    excerpt: "Sync contacts, deals, and conversation data bidirectionally between OmniChat and your CRM.",
    ...
    steps: [
      ...
      { title: "Configure Field Mappings", body: "Map OmniChat contact fields to CRM fields. Standard mappings are pre-built (email, phone, company). Add custom field mappings for your specific CRM properties.", imagePlaceholder: "Screenshot: Field mapping configuration table" },
      { title: "Set Sync Direction", body: "Choose per-field: OmniChat → CRM only, CRM → OmniChat only, or Bidirectional. For most teams: bidirectional for contacts, OmniChat → CRM for conversation timestamps and labels." },
      ...
      { title: "Test the Sync", body: "Create a test contact in OmniChat and verify it appears in your CRM within 60 seconds. Update a field in the CRM and confirm it reflects in OmniChat.", imagePlaceholder: "Screenshot: Sync activity log showing successful contact sync events" },
    ],
  ...
  },
  {
    ...
    excerpt: "Use OmniChat&#39;s native Zapier and Make apps to connect with 5,000+ external tools — no code required.",
    category: "integrations",
    ...
    steps: [
      ...
      { title: "Zapier Setup", body: "In Zapier, search for OmniChat. Click Connect and enter your API key. Create a Zap with OmniChat as Trigger (e.g. New Conversation) or Action (e.g. Send Message, Create Contact).", imagePlaceholder: "Screenshot: Zapier OmniChat app with trigger/action options listed" },
      { title: "Make (Integromat) Setup", body: "In Make, add the OmniChat module. Authenticate with your API key. Available modules: Watch Conversations, Send Message, Create Contact, Update Contact, Search Contacts.", imagePlaceholder: "Screenshot: Make scenario canvas with OmniChat module connected to Google Sheets" },
  ...
  /* ══ ANALYTICS ══ */
  {
    ...
    excerpt: "Understand every report available in OmniChat — team performance, CSAT, conversation metrics, and custom dashboards.",
    category: "analytics",
    section: "reports",
  ...
  /* ══ DEVELOPER API ══ */
  {
    ...
    excerpt: "Introduction to OmniChat&#39;s RESTful API — authentication, base URLs, rate limits, pagination, and error codes.",
    category: "developer",
  ...
  /* ══ SECURITY & COMPLIANCE ══ */
  {
    ...
    excerpt: "OmniChat&#39;s security architecture, compliance certifications, data residency options, and GDPR tools for enterprise customers.",
    category: "security",
    section: "compliance",
    ...
    author: AUTHORS.alex,
    steps: [
      { title: "Data Encryption", body: "All data is encrypted in transit using TLS 1.3 and at rest using AES-256. Message content, contact data, and attachments are stored in encrypted form with keys managed via AWS KMS.", imagePlaceholder: "Diagram: OmniChat data encryption architecture overview" },
      { title: "Compliance Certifications", body: "OmniChat holds: SOC 2 Type II, ISO 27001, and GDPR compliance (EU). Enterprise plans include BAA for HIPAA-eligible US healthcare customers. Compliance documents available on request from your account manager.", imagePlaceholder: "Placeholder: Compliance badge grid — SOC2, ISO27001, GDPR, HIPAA" },
  ...
  /* ══ BILLING ══ */
  {
    ...
    excerpt: "Understand OmniChat pricing tiers, manage your subscription, add seats, download invoices, and handle upgrades.",
    category: "billing",
    ...
    steps: [
      ...
      { title: "Payment Methods", body: "OmniChat accepts all major credit cards (Visa, Mastercard, Amex) and ACH bank transfers (US only, Enterprise). Go to Billing → Payment Methods to add or update." },
