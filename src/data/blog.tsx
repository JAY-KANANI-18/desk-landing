...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    featured: true,
    og: {
      title: "AI Agent 2.0: Fully Autonomous Customer Conversations — OmniChat Blog",
  ...
  },
  {
    ...
    featured: true,
    og: {
      title: "WhatsApp Cart Recovery Playbook: 3× Revenue — OmniChat Blog",
  ...
  },
  {
    ...
    excerpt: "Not every workflow needs AI, and not every workflow can be solved with rules. Here&#39;s the definitive decision framework used by 500+ OmniChat teams.",
    ...
    featured: false,
    og: {
      title: "AI vs Rules-Based Automation: How to Choose — OmniChat Blog",
  ...
  },
  {
    ...
    excerpt: "Bolt&#39;s sales team was drowning in unqualified leads from Facebook ads. Within 90 days of deploying OmniChat, they quadrupled qualified pipeline.",
    ...
    industry: "mobility",
    og: {
      title: "How Bolt Got 4× More Leads With OmniChat — Case Study",
  ...
  },
  {
    ...
    status: "published",
    title: "WhatsApp Business Calling API Is Now Available in OmniChat",
    excerpt: "Voice calls, messages, and emails — all in a single thread. OmniChat now natively supports the WhatsApp Business Calling API for all Growth+ plans.",
    ...
    featured: false,
    og: {
      title: "WhatsApp Business Calling API Now in OmniChat",
  ...
  },
  {
    ...
    og: {
      title: "Real Estate Lead Nurturing on WhatsApp: Complete Guide — OmniChat",
  ...
  {
    id: "007",
    slug: "building-webhooks-omnichat-api",
    status: "published",
    title: "Building Real-Time Event Pipelines With the OmniChat Webhook API",
    ...
    featured: false,
    og: {
      title: "Building Real-Time Pipelines With OmniChat Webhooks — Dev Blog",
  ...
  },
  {
    ...
    featured: false,
    og: {
      title: "Cut Customer Support Costs 40% With AI — OmniChat Blog",
  ...
  },
  {
    ...
    excerpt: "One OmniChat customer sent 4 precisely timed WhatsApp broadcast campaigns over Black Friday weekend and generated $2M in direct-attributable revenue.",
    body: `<p>Black Friday is the Super Bowl of e-commerce. Here&#39;s how one brand used OmniChat to make it their biggest day ever...</p>`,
    category: "growth-strategy",
    categoryLabel: "Growth Strategy",
  ...
  },
  {
    ...
    status: "published",
    title: "Decathlon: Scaling a Global Support Team With OmniChat AI",
    ...
    industry: "retail",
    og: {
      title: "Decathlon: Scaling Global Support With AI — OmniChat Case Study",
