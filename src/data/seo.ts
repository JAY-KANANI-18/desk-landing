...
export const SITE_URL = "https://axodesk.in";

/* ─────────────────────────────────────────────────────── */
/* HOME                                                   */
/* ─────────────────────────────────────────────────────── */
export const HOME_SEO = {
  title: "AxoDesk — #1 Omnichannel Customer Messaging Platform | WhatsApp, Instagram, Email",
  description: "AxoDesk unifies WhatsApp Business API, Instagram DMs, Facebook Messenger, Email & Live Chat in one powerful inbox. AI automation, no-code workflows, real-time analytics. Better than respond.io & SleekFlow. Start free.",
...
export const FEATURES_SEO = {
  ...
  description: "Explore AxoDesk's full feature set: unified omnichannel inbox, no-code automation builder, AI chatbot, team collaboration, advanced analytics, CRM, and enterprise security. Everything to scale customer conversations.",
...
export const PRICING_SEO = {
  ...
  description: "AxoDesk pricing plans for every team size. Starter $29/mo, Growth $79/mo, Business $149/mo. 14-day free trial, no credit card needed. Compare with respond.io, sleekflow — we beat them all.",
  keywords: "omnichannel software pricing, WhatsApp business platform cost, AxoDesk plans, customer messaging software price, respond.io pricing alternative, sleekflow pricing alternative, omnichannel inbox pricing, WhatsApp API pricing, business chat software cost, affordable customer support platform",
...
export const WHY_US_SEO = {
  title: "Why Choose AxoDesk? Best respond.io & SleekFlow Alternative",
  description: "Why thousands choose AxoDesk over respond.io, sleekflow, or Intercom. True omnichannel unification, AI automation on day 1, live in 24h, 40% faster response times, and transparent pricing. See the comparison.",
  keywords: "respond.io alternative, sleekflow alternative, intercom alternative, best omnichannel platform, AxoDesk vs respond.io, AxoDesk vs sleekflow, why choose AxoDesk, best WhatsApp business platform, omnichannel CRM comparison, WhatsApp inbox comparison, best customer messaging software 2025",
...
export const INDUSTRY_SEO: Record<string, { title: string; description: string; keywords: string }> = {
  ecommerce: {
    title: "AxoDesk for E-commerce — WhatsApp Sales, Cart Recovery & Customer Support",
    description: "Scale e-commerce with AxoDesk: unified inbox, WhatsApp cart recovery, Instagram DM support, Shopify sync, and AI automation. 3× more sales with omnichannel messaging.",
  ...
  "real-estate": {
    title: "AxoDesk for Real Estate — WhatsApp Lead Response & Property Booking",
  ...
  education: {
    title: "AxoDesk for Education — Student Enrollment Automation & WhatsApp Support",
    description: "Automate admissions, manage student queries across WhatsApp and email, and increase enrollment conversions with AxoDesk.",
  ...
  healthcare: {
    title: "AxoDesk for Healthcare — WhatsApp Appointment Reminders & Patient Communication",
  ...
  finance: {
    title: "AxoDesk for Financial Services — Secure Client Messaging & Onboarding",
  ...
  food: {
    title: "AxoDesk for Restaurants & Food Delivery — WhatsApp Reservations & Orders",
  ...
  automotive: {
    title: "AxoDesk for Automotive — WhatsApp Test Drive Booking & Service Reminders",
  ...
  professional: {
    title: "AxoDesk for Professional Services — Client Communication & Lead Automation",
    description: "Automate client intake, deliver proposals, and update projects via WhatsApp. Close deals 60% faster with AxoDesk.",
  ...
  travel: {
    title: "AxoDesk for Travel & Hospitality — Booking Automation & Guest Communication",
  ...
  retail: {
    title: "AxoDesk for Retail — WhatsApp Commerce, Customer Support & Loyalty Programs",
...
export const BLOG_LIST_SEO = {
  title: "AxoDesk Blog — WhatsApp Marketing, AI Automation & Omnichannel Growth",
  description: "Expert guides, case studies, AI automation playbooks, and product updates from AxoDesk. Learn how to 3× leads, cut support costs, and master messaging at scale.",
  keywords: "omnichannel messaging blog, WhatsApp marketing strategy, AI customer support tips, WhatsApp automation guide, customer communication insights, messaging platform updates, axodesk blog",
...
export const HELP_CENTER_SEO = {
  title: "AxoDesk Help Center — Documentation, Guides & API Reference",
  description: "Step-by-step guides, API documentation, automation tutorials, and answers to every AxoDesk question. Self-serve help for teams of all sizes.",
  keywords: "axodesk help center, omnichannel platform documentation, whatsapp api guide, messaging platform tutorial, axodesk support, axodesk api docs",
...
export const WHATSAPP_LINK_SEO = {
  title: "Free WhatsApp Link Generator — Create wa.me Links Instantly | AxoDesk",
