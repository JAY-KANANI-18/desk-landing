...
<todo id="live-chat-widget">
Add Website Live Chat Widget
A floating chat widget component users can embed on their site — showcase it in the hero/features section
</todo>

<todo id="why-us-video">
Add demo video to Why Us page
A 2-minute product walkthrough video (embedded or mocked) in the hero section of /why-us drives massive conversion uplift
</todo>

<todo id="onboarding-flow">
Build an interactive onboarding/signup flow
Multi-step form: company info → connect channels → invite team → go live
</todo>

<todo id="real-screenshots">
Replace placeholder dashboard with real UI screenshots
Hero dashboard and feature section visuals would look much more premium with actual product screenshots
</todo>

<todo id="resources-live-links">
Wire up Resources page links to real content
Blog articles, docs pages, and help center articles are currently placeholder — populate with real or mocked content
</todo>

<todo id="seo-meta">
Add SEO meta tags and Open Graph per page
Each page (features, pricing, industry) needs unique title, description, OG image for shareability
</todo>
